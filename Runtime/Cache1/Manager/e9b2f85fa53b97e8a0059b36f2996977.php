...
<div class="main">
    <div class="top" onclick="viewExplanToggle();">
    	<div class="k">
        	添加微信号：<b style="font-size:24px;">天津大学团委</b> 或 <b style="font-size:24px;">y02tju</b><br />发送 <b style="font-size:24px;">#社会实践#+内容</b> 即可上墙！
        </div>
    </div>
	<div class="wall">
		<div class="left"></div>
	...
	<div id="explan" style="display:none" onclick="viewExplanToggle();">
    	<div class="explain_half"><p>
            ...
            <!--<b style="color:#FDCB08;font-size:36px;"">【发消息参与互动】</b>--><br />发送<b style="color:#FDCB08;font-size:40px;">#社会实践#+内容</b><br />即可上墙！
        </p></div>
