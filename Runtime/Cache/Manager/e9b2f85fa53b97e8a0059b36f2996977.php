...
<div class="main">
    <div class="top" onclick="viewExplanToggle();">
    	<div class="k">
        	添加微信号：<b style="font-size:24px;">天津大学团委</b> 或 <b style="font-size:24px;">y02tju</b><br />发送 <b style="font-size:24px;">#<?php echo ($activity['name']); ?>#+内容</b> 即可上墙！
        </div>
	...
	<div class="wall">
		<div class="left" onclick="$('#setting').fadeToggle()"></div>
		<div class="center">
			<div class="list">
				<ul id="list"></ul>
			</div>
	...
	<div id="explan" style="display:none" onclick="viewExplanToggle();">
    	<div class="explain_half"><p>
            ...
            <!--<b style="color:#FDCB08;font-size:36px;"">【发消息参与互动】</b>--><br />发送<b style="color:#FDCB08;font-size:40px;">#<?php echo ($activity['name']); ?>#+内容</b><br />即可上墙！
        </p></div>
...
<!--<div style="position: relative;top:20px;left:350px;" onclick=><div><img id="show_hide" src="__ROOT__/Public/Images/set.png"></div> -->
