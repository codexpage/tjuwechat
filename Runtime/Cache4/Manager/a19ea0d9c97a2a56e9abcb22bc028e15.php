...
.lottery_btn {background:url("__ROOT__/Public/Images/lotteryboard/scroll_lottery.png") center;width:263px;height:36px;margin-top:10px;color:#fdcb08;}
#special_lottery_btn {background:url("__ROOT__/Public/Images/lotteryboard/scroll_lottery.png") center;width:263px;height:36px;margin-top:10px;color:#fdcb08;}
...
<body>
	<div class="wrapper">
		<div id="header">
			<div style="color:#ffffff;font-size:38px;float:left;margin:30px 0px 0px 110px">『四海同心向北洋』天津大学2014届毕业晚会</div>
			<div class="clear"></div>
		...
		<div id="content">
			<div style="background:url('__ROOT__/Public/Images/lotteryboard/mask1.png');width:340px" class="content_bg">
				...
				<div id='scroll'><p class='name'>&nbsp;</p></div>
				<button class="lottery_btn" lottery="1" num="6" v="一等奖 6"></button>
